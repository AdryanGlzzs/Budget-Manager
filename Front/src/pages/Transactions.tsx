  ...
  const Transactions = () => {
    ...
    return (
      <div className="min-h-screen bg-[#050510] text-white overflow-hidden">
                  ...
                  <div className="divide-y divide-white/5">
                    {filteredTransactions.map((transaction) => {
                      ...
                      return (
                        <div
                          key={transaction.id}
                          className="px-4 py-4 sm:px-6 sm:py-5 hover:bg-white/5 transition-all cursor-pointer"
                        >
                            ...
                            <div className="flex items-center justify-between mt-1">
                              ...
                              <span
                                className={`px-2 py-1 rounded-lg text-[11px] font-medium whitespace-nowrap ${
                                  transaction.status === true && transaction.type === 'revenue'
        ...
        <div>
          <TransactionModal Isopen={openModal} close={() => setOpenModal(false)} onSave={HandleSaveTransaction}
          />
        </div>
      </div>
    );
